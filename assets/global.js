...
// const navLabels = document.querySelectorAll(".nav-lables .label");
// const dropdownMenu = document.querySelectorAll('dropdown-menu');
// // console.log(navLabels, dropdownMenu);
// let count = 0;
// console.log(count);
// dropdownMenu.forEach(menuItem => {
//   count = count + 1;
//   const itemlabel = menuItem.querySelector('a').dataset.label;
//   // const label = navLabels[count].dataset.label;
//   // if (itemlabel == label){
//   //   console.log('true')
//   //   menuItem.querySelector('a').appendChild(navLabels[count]);
//   // }
// });
// for (let index = 0; index < 10; index++) {
